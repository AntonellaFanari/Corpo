...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: 'test-templates-list', component: TestTemplateListComponent, canActivate: [AuthGuard], data: { name: 'wod' } },
      { path: 'test-template-crear', component: TestTemplateCreateComponent, canActivate: [AuthGuard], data: { name: 'wod' } },
      { path: 'test-template-editar', component: TestTemplateEditComponent, canActivate: [AuthGuard], data: { name: 'wod' } },
      { path: 'test-asignacion', component: TestAssignmentCreateComponent, canActivate: [AuthGuard], data: { name: 'wod' } },
      { path: 'test', component: TestListComponent, canActivate: [AuthGuard], data: { name: 'test' } },
      { path: 'test-asignado-editar', component: TestAssignmentEditComponent, canActivate: [AuthGuard], data: { name: 'wod' } },
      { path: 'test-asignados-list', component: TestAssignmentListComponent, canActivate: [AuthGuard], data: { name: 'wod' } },
      { path: 'resultado-test', component: TestResultComponent, canActivate: [AuthGuard], data: { name: 'wod' } },
      { path: 'test-detalle', component: TestDetailComponent, canActivate: [AuthGuard], data: { name: 'wod' } },
      { path: 'test-asignado-detalle', component: TestAssignmentDetailComponent, canActivate: [AuthGuard], data: { name: 'wod' } },
      { path: 'anamnesis', component: AnamnesisResultComponent, canActivate: [AuthGuard], data: { name: 'wod' } },
      { path: 'menu-wod', component: MenuWodComponent, canActivate: [AuthGuard], data: { name: 'wod' } },
