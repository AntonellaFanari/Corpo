...
namespace Corpo.Data.Migrations
{
    ...
    [Migration("20220413203808_UpdateDataTypeTimeColumnAndVideoColumnTestExerciseTable")]
    partial class UpdateDataTypeTimeColumnAndVideoColumnTestExerciseTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestExerciseTestTemplate", b =>
                {
                    b.Property<int>("TestExercisesId")
                        .HasColumnType("int");

                    b.Property<int>("TestTemplatesId")
                        .HasColumnType("int");

                    b.HasKey("TestExercisesId", "TestTemplatesId");

                    b.HasIndex("TestTemplatesId");

                    b.ToTable("TestExerciseTestTemplate");
                });
            ...
            modelBuilder.Entity("TestExerciseTestTemplate", b =>
                {
                    b.HasOne("Corpo.Domain.Models.TestExercise", null)
                        .WithMany()
                        .HasForeignKey("TestExercisesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Corpo.Domain.Models.TestTemplate", null)
                        .WithMany()
