...
@Component({
  selector: 'app-workout-periodizaion-edit',
  templateUrl: './workout-periodizaion-edit.component.html',
  styleUrls: ['./workout-periodizaion-edit.component.css']
})
export class WorkoutPeriodizaionEditComponent implements OnInit {
  canvas: any;
  ctx: any;
  metabolic: number = 25;
  gymnastic: number = 25;
  ...
  getPeriodizationById() {
    this.periodizacionService.getById(this.id).subscribe(data => {
      ...
      this.trainingSystemMonthly = this.periodization.trainingSystem;
      this.selectedTrainingSystemMonthly = this.getTrainingSystemId(this.periodization.trainingSystem);
      this.week1 = this.periodization.periodizationWeeks.find(x => x.weekNumber == "1");
      this.selectIntensityType(this.week1.intensityType, 1);
      this.selectedTrainingSystemWeek1 = this.getTrainingSystemId(this.week1.trainingSystem);
      this.week2 = this.periodization.periodizationWeeks.find(x => x.weekNumber == "2");
      this.selectIntensityType(this.week2.intensityType, 2);
      this.selectedTrainingSystemWeek2 = this.getTrainingSystemId(this.week2.trainingSystem);
      this.week3 = this.periodization.periodizationWeeks.find(x => x.weekNumber == "3");
      this.selectIntensityType(this.week3.intensityType, 3);
      this.selectedTrainingSystemWeek3 = this.getTrainingSystemId(this.week3.trainingSystem);
      this.week4 = this.periodization.periodizationWeeks.find(x => x.weekNumber == "4");
      this.selectIntensityType(this.week4.intensityType, 4);
      this.selectedTrainingSystemWeek4 = this.getTrainingSystemId(this.week4.trainingSystem);
  ...
  getMonthlyGoals() {
    this.monthlyGoalService.getAll().subscribe(
      response => {
        ...
        this.selectedMonthlyGoals = this.monthlyGoalsList;
      },
      error => console.error(error))
  }
  ...
  getWeeklyGoals() {
    this.weeklyGoalService.getAll().subscribe(
      response => {
        ...
        for (var i = 0; i < this.periodization.periodizationWeeks.length; i++) {
          let goalsList = this.periodization.periodizationWeeks[i].goal.split("-");
          console.log("objetivos string ", goalsList);
          let goals = this.getWeeklyGoalsSelected(goalsList);
          switch (i + 1) {
            case 1:
              this.week1GoalsList = goals;
              this.selectedWeek1Goals = this.week1GoalsList;
              console.log("objetivos seleccionado semana 1 ", this.selectedWeek1Goals);
              break;
            case 2:
              this.week2GoalsList = goals;
              this.selectedWeek2Goals = this.week2GoalsList;
              console.log("objetivos seleccionado semana 2 ", this.selectedWeek2Goals);
              break;
            case 3:
              this.week3GoalsList = goals;
              this.selectedWeek3Goals = this.week3GoalsList;
              console.log("objetivos seleccionado semana 3 ", this.selectedWeek3Goals);
              break;
            case 4:
              this.week4GoalsList = goals;
              this.selectedWeek4Goals = this.week4GoalsList;
              console.log("objetivos seleccionado semana 4 ", this.selectedWeek4Goals);
              break;
            default:
          }
        }
  ...
  getWeeklyGoalsSelected(goalsList) {
    let goals = [];
    for (var j = 0; j < goalsList.length; j++) {
      let goal = this.weeklyGoals.find(x => x.goal == goalsList[j]);
      goals.push(goal);
    }
  ...
  save() {
    ...
    periodization.id = this.periodization.id;
