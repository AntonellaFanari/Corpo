...
namespace Corpo.Data.Migrations
{
    ...
    [Migration("20220106053505_CreatePromotionAnotherMemberTable")]
    partial class CreatePromotionAnotherMemberTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Corpo.Domain.Models.PromotionAnotherMember", b =>
                {
                    b.HasOne("Corpo.Domain.Models.Promotion", "Promotion")
                        .WithMany("PromotionAnotherMembers")
                        .HasForeignKey("PromotionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Corpo.Domain.Models.Promotion", b =>
                {
                    b.Navigation("PromotionAnotherMembers");
                });
