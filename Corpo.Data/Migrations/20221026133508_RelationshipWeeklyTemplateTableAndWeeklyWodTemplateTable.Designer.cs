...
namespace Corpo.Data.Migrations
{
    ...
    [Migration("20221026133508_RelationshipWeeklyTemplateTableAndWeeklyWodTemplateTable")]
    partial class RelationshipWeeklyTemplateTableAndWeeklyWodTemplateTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BalancePaidBalanceToPay", b =>
                {
                    b.Property<int>("BalancesPaidsId")
                        .HasColumnType("int");

                    b.Property<int>("BalancesToPayId")
                        .HasColumnType("int");

                    b.HasKey("BalancesPaidsId", "BalancesToPayId");

                    b.HasIndex("BalancesToPayId");

                    b.ToTable("BalancePaidBalanceToPay");
                });
            ...
            modelBuilder.Entity("Corpo.Domain.Models.Anamnesis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("ConstantfollowUpSpreadsheet")
                        .HasColumnType("bit");

                    b.Property<bool>("CurrentlyPhysicalActivity")
                        .HasColumnType("bit");

                    b.Property<bool>("CurrentlyStrengthTraining")
                        .HasColumnType("bit");

                    b.Property<int>("HoursStrengthTrainingSessionsWeek")
                        .HasColumnType("int");

                    b.Property<int>("HoursTrainingSessionsWeek")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("NumberStrengthTrainingSessionsWeek")
                        .HasColumnType("int");

                    b.Property<int>("NumberTrainingSessionsWeek")
                        .HasColumnType("int");

                    b.Property<bool>("PhysicalActivityInThePast")
                        .HasColumnType("bit");

                    b.Property<bool>("RecreationalAndSporadic")
                        .HasColumnType("bit");

                    b.Property<string>("Sport")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("StrengthTrainingInThePast")
                        .HasColumnType("bit");

                    b.Property<string>("TimeSinceLastTraining")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Corpo.Domain.Models.BalancePaid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Corpo.Domain.Models.CancelBalancePaid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("BalancePaidId");

                    b.ToTable("CancelBalancePaid");
                });
            ...
            modelBuilder.Entity("Corpo.Domain.Models.ExerciseFMS", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Corpo.Domain.Models.FileFMS", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Corpo.Domain.Models.Periodization", b =>
                {
                    ...
                    b.Property<string>("TrainingSystem")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Corpo.Domain.Models.PhysicalLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Corpo.Domain.Models.ResultsWodGroupMemberExercise", b =>
                {
                    ...
                    b.Property<int>("ResultsWodGroupMemberId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ResultsWodGroupMemberId");
            ...
            modelBuilder.Entity("Corpo.Domain.Models.TestExercise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Corpo.Domain.Models.TrainingSystem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Corpo.Domain.Models.WeeklyTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Corpo.Domain.Models.WodGroupMember", b =>
                {
                    ...
                    b.HasIndex("WodMemberId");

                    b.ToTable("WodGroupMember");
                });
            ...
            modelBuilder.Entity("BalancePaidBalanceToPay", b =>
                {
                    b.HasOne("Corpo.Domain.Models.BalancePaid", null)
                        .WithMany()
                        .HasForeignKey("BalancesPaidsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Corpo.Domain.Models.BalanceToPay", null)
                        .WithMany()
                        .HasForeignKey("BalancesToPayId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Corpo.Domain.Models.CancelBalancePaid", b =>
                {
                    b.HasOne("Corpo.Domain.Models.BalancePaid", "BalancePaid")
                        .WithMany()
                        .HasForeignKey("BalancePaidId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BalancePaid");
                });
            ...
            modelBuilder.Entity("Corpo.Domain.Models.FileFMS", b =>
                {
                    b.HasOne("Corpo.Domain.Models.ExerciseFMS", "ExerciseFMS")
                        .WithMany("Files")
                        .HasForeignKey("ExerciseFMSId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ExerciseFMS");
                });
            ...
            modelBuilder.Entity("Corpo.Domain.Models.ResultsWodGroupMemberExercise", b =>
                {
                    b.HasOne("Corpo.Domain.Models.ResultsWodGroupMember", "ResultsWodGroupMember")
                        .WithMany("ResultsWodGroupMemberExercise")
                        .HasForeignKey("ResultsWodGroupMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ResultsWodGroupMember");
            ...
            modelBuilder.Entity("Corpo.Domain.Models.TestExercise", b =>
                {
                    ...
                    b.HasOne("Corpo.Domain.Models.TestTemplate", "TestTemplate")
            ...
            modelBuilder.Entity("Corpo.Domain.Models.WodGroupMember", b =>
                {
                    ...
                    b.HasOne("Corpo.Domain.Models.WodMember", "WodMember")
                        .WithMany("WodGroupsMember")
                        .HasForeignKey("WodMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Corpo.Domain.Models.WeeklyTemplate", b =>
                {
                    b.Navigation("WeeklyWodTemplates");
                });
